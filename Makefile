...
clean:
	rm -rf \
		...
		soc.rkt \
		compiled \
		verify-cycles-*.rkt verify_cycles_*.sby verify_cycles_*.sv bench-*.txt
...
.PHONY: generate
generate: soc.rkt verify-template.rkt.tmpl verify_template.sby.tmpl verify_template.sv.tmpl
